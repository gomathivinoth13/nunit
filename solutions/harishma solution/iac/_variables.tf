...
variable "dynatrace_tenant" {
  type        = string
  description = "(required) tenant name for Dynatrace extension"
  default     = "qds48093"
}

variable "dynatrace_ssl_mode" {
  type        = string
  description = "(required) SSL mode for Dynatrace extension"
  default     = "default"
}

variable "salesforceapimbaseendpoint" {
  type        = string
  description = "(required) BaseEndpoint of SFMC apim"
}

variable "salesforceapimauthendpoint" {
  type        = string
  description = "(required) AuthBaseEndpoint of SFMC apim"
}
